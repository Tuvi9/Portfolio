function Home () {
    return(
        <div className='grid min-h-screen justify-center items-center content-center'>
            ...
            <a href='https://tailwindcss.com/docs/background-image#adding-a-linear-gradient'>
                <button type='button'>
                    <span className='text-white font-semibold text-2xl bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-full px-[75px] p-3'>Button</span>
                </button>
            </a>
            </div>
        </div>
